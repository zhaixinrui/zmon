...
class JsGenerate(object):
    def __init__(self, username, products):
        ...
        self.jsfile = '../webroot/js/flowstat.%s.js' % username
...
#                        self.str += '},\n'
    ...
    def writeJs(self):
        ...
        f.write(jstemplate_flowstat.head.encode('UTF-8'))
        f.write(self.str.encode('UTF-8'))
        f.write(jstemplate_flowstat.foot.encode('UTF-8'))
        f.close()
